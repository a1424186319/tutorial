# 糗事百科热点文章爬取
# 请求的  url  https://www.qiushibaike.com/hot/page/1/   要抓取div class = 'article'下内容     urllib或request,
...
<input type="hidden" name="_xsrf" value="2|cbe005d2|83b747837554f8da0f37d9e28853e125|1544585697"/>
...
results = re.search(pattern,html_content)
print(results)