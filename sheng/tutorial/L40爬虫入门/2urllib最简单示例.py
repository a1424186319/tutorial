...
# import urllib  # urllib包下的__init__.py没写东西，import urllib写法并不会引入其它文件。
...
# 总结：现在我们用的http相关处理包，主要有内置的urllib，第三方requests这两个包。urllib包稍微偏底层，代码稍麻烦但原理清楚；requests封装良好使用简单。
"""