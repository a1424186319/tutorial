...
另外的安装方法
1.源码安装.从github包的主页/releases找到 source.解压.cd到解压后的包根目录
python setup.py install
优点:适合任何操作系统和python版本.缺点:有些包源码调用了C++代码,但本机没有C++编译器,编译报错.
2.wheel文件安装.wheel文件是有人已经安装好C++编译器,根据操作系统和python版本编译好这种平台上可运行的二进制.pip上安装的包实际上就是平台为我们准备好的适合当前操作系统的.wheel文件
pypi上查找下载对应版本的.whl文件.
pip install requests_x64_win_py36.whl
优点:不会报错
3. pip install 包名
第2种方式的自动化.
"""
